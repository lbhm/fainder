...
cluster-histograms -i data/sportstables/histograms.zst \
    ...
    --alpha 1 \
    --seed 42
generate-queries -o data/sportstables/queries/all.zst \
    --n-percentiles 20 \
...
python experiments/collate_benchmark_queries.py \
    -d sportstables \
    -q data/sportstables/queries/all.zst \
...
cluster-histograms -i data/open_data_usa/histograms.zst \
    ...
    --alpha 1 \
    --seed 42
generate-queries -o data/open_data_usa/queries/all.zst \
    --n-percentiles 20 \
    --n-reference-values 100 \
    --seed 42 \
...
python experiments/collate_benchmark_queries.py \
    -d open_data_usa \
    -q data/open_data_usa/queries/all.zst \
...
cluster-histograms -i data/gittables/histograms.zst \
    ...
    --alpha 1 \
    --seed 42
generate-queries -o data/gittables/queries/all.zst \
    --n-percentiles 10 \
    --n-reference-values 100 \
    --seed 42 \
...
python experiments/collate_benchmark_queries.py \
    -d gittables \
    -q data/gittables/queries/all.zst \
